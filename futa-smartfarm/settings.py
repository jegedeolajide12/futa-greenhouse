...
STATICFILES_STORAGE = 'cloudinary_storage.storage.StaticHashingCloudinaryStorage'
...
# django-allauth
LOGIN_REDIRECT_URL = "products:shop"          # where to go after login
...
# Social account – we want to use email from Google
